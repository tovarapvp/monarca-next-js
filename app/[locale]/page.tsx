        ...
        <div className="min-h-screen bg-background">
            ...
            <section className="relative h-[calc(100vh-4rem)] min-h-[500px] overflow-hidden">
                ...
                <div className="relative z-10 flex h-full items-center justify-center text-center text-white">
                    <div className="max-w-2xl px-4 animate-fade-in">
                        <h1 className="mb-4 text-4xl font-serif font-bold sm:text-5xl md:text-6xl">{t('home.hero.title')}</h1>
                        <p className="mb-8 text-lg font-light md:text-xl">{t('home.hero.subtitle')}</p>
                        <Link href="/products">
                            <Button
                                size="lg"
                ...
                <div className="container mx-auto max-w-6xl px-4">
                    <div className="grid gap-8 md:grid-cols-4 text-center">
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <h3 className="font-semibold text-foreground">{t('home.trust.warranty')}</h3>
                            <p className="text-sm text-muted-foreground">{t('home.trust.warrantyDesc')}</p>
                        </div>
                        <div className="flex flex-col items-center gap-2">
                            <Award className="h-8 w-8 text-primary" />
                            <h3 className="font-semibold text-foreground">{t('home.trust.handcrafted')}</h3>
                            <p className="text-sm text-muted-foreground">{t('home.trust.handcraftedDesc')}</p>
                        </div>
                        <div className="flex flex-col items-center gap-2">
                            <Users className="h-8 w-8 text-primary" />
                            <h3 className="font-semibold text-foreground">{t('home.trust.customers')}</h3>
                            <p className="text-sm text-muted-foreground">{t('home.trust.customersDesc')}</p>
                        </div>
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <h3 className="font-semibold text-foreground">{t('home.trust.rating')}</h3>
                            <p className="text-sm text-muted-foreground">{t('home.trust.ratingDesc')}</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 px-4">
                <div className="container mx-auto max-w-6xl">
                    <h2 className="mb-12 text-center text-4xl font-serif font-bold text-foreground">{t('home.categories.title')}</h2>
            ...
            <section className="bg-muted py-20 px-4">
                <div className="container mx-auto max-w-6xl">
                    <div className="mb-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <h2 className="text-3xl sm:text-4xl font-serif font-bold text-foreground text-center sm:text-left">{t('home.arrivals.title')}</h2>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-12">
                            <p className="text-muted-foreground">{t('products.unableToLoad')}</p>
                        </div>
                    ) : (
                        <div className="grid gap-6 md:grid-cols-4">
                ...
                <div className="container mx-auto max-w-6xl">
                    <div className="grid gap-12 md:grid-cols-2 items-center">
                        ...
                        <div className="order-1 md:order-2">
                            <h2 className="mb-6 text-4xl font-serif font-bold text-foreground">{t('home.story.title')}</h2>
                            ...
                            <div className="mb-8 space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-muted-foreground">{t('home.story.ethical')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="h-2 w-2 rounded-full bg-primary"></div>
                                    <span className="text-muted-foreground">{t('home.story.artisans')}</span>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="h-2 w-2 rounded-full bg-primary"></div>
                                    <span className="text-muted-foreground">{t('home.story.guarantee')}</span>
                                </div>
                            </div>
                            <Button asChild variant="outline" size="lg" className="hover:bg-primary hover:text-primary-foreground transition-colors bg-transparent">
                                <Link href="/about">{t('home.story.cta')}</Link>
                            </Button>
                        </div>
                    </div>
                </div>
            ...
            <section className="bg-muted py-20 px-4">
                <div className="container mx-auto max-w-6xl">
                    <h2 className="mb-12 text-center text-4xl font-serif font-bold text-foreground">{t('home.testimonials.title')}</h2>
                    <div className="grid gap-8 md:grid-cols-3">
                        {[
                            {
                                name: "Sarah Johnson",
            ...
            <section className="py-20 px-4">
                <div className="container mx-auto max-w-6xl">
                    <h2 className="mb-12 text-center text-4xl font-serif font-bold text-foreground">{t('home.instagram.title')}</h2>
            ...
            <footer className="border-t border-border bg-background py-12 px-4 sm:px-6 lg:px-8">
                <div className="container mx-auto max-w-7xl">
                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="sm:col-span-2 lg:col-span-1">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <span className="text-sm text-muted-foreground ml-2">{t('footer.rating')}</span>
                            </div>
                        </div>
                        <div>
                            <h3 className="mb-4 font-semibold text-foreground">{t('footer.shop')}</h3>
                        ...
                        <div>
                            <h3 className="mb-4 font-semibold text-foreground">{t('footer.support')}</h3>
                            <ul className="space-y-3 text-sm text-muted-foreground">
                                <li>
                        ...
                        <div>
                            <h3 className="mb-4 font-semibold text-foreground">{t('footer.connect')}</h3>
                            <ul className="space-y-3 text-sm text-muted-foreground">
                                <li>
                                    <a href="#" className="hover:text-primary transition-colors">
                                        {t('footer.instagram')}
                    ...
                    <div className="mt-10 border-t border-border pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-muted-foreground text-center sm:text-left">{t('footer.rights')}</p>
